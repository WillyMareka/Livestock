...
public class BreedAdd extends AppCompatActivity {

    Button btncanceladd,btnlivestock;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnlivestock = (Button) findViewById(R.id.btnlivestock);

        breedlist = new ArrayList<>();
        lv = (ListView) findViewById(R.id.lvaddbreed);
    ...
    public void BacktoLivestock(){
        btnlivestock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private class GetAllBreed extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(BreedAdd.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent breed = new Intent(BreedAdd.this, PriceDescription.class);
